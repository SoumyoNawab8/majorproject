...
--
-- Host: localhost:3306
-- Generation Time: May 09, 2018 at 04:20 PM
...
INSERT INTO `admin` (`Username`, `First_Name`, `Last_Name`, `Password`, `Register_date`) VALUES
('admin', 'Soumyojyoti', 'Majumdar', '123456', '2018-04-30 18:45:09');
...
INSERT INTO `posts` (`id`, `title`, `slug`, `body`, `created at`) VALUES
(1, 'Mobile_1', 'mobile_1', 'Android Oreo 8.0 was revealed by Google on August 21st 2017, with the much hyped Solar Eclipse which was happening that day. Android Oreo has already started to be pushed on to many phones including Pixel & Nexus, but like most of other phones, Lenovo users has to wait for its turn for the Lenovo Android Oreo Update.', '2018-04-16 20:27:20'),
(2, 'mobile_2', 'mobile2', 'In this page, we’re listing all the Lenovo phones that will be getting the Lenovo Android 8.0 Oreo update through OTA officially. We’ve listed all the phones that are confirmed to get Android 8.0 Oreo update officially, and the ones which are expected to be getting OTA update. Read on!', '2018-04-16 20:32:31'),
(3, 'mobile_3', 'mobile3', 'this page, we’re listing all the Lenovo phones that will be getting the Lenovo Android 8.0 Oreo update through OTA officially. We’ve listed all the phones that are confirmed to get Android 8.0 Oreo update officially, and the ones which are expected to be getting OTA update. Read on!this page, we’re listing all the Lenovo phones that will be getting the Lenovo Android 8.0 Oreo update through OTA officially. We’ve listed all the phones that are confirmed to get Android 8.0 Oreo update officially, and the ones which are expected to be getting OTA update. Read on!', '2018-04-17 07:05:49');
...
INSERT INTO `UserLog` (`id`, `Name`, `Email`, `Password`, `Register_date`) VALUES
(7, 'dcadx', 'patmdpt1@gmail.com', '', '2018-04-30 18:45:47'),
(12, 'df', 'patmdpt21@gmail.com', 'Qwe@1234', '2018-04-30 18:45:47'),
(10, 'df', 'patmdpt2@gmail.com', '', '2018-04-30 18:45:47'),
(15, 'Ret', 'patmdpt4@gmail.com', 'Qwe@1234a', '2018-04-30 18:45:47'),
(16, 'kioam', 'patmdpt5@gmail.com', 'Qwe@1234', '2018-04-30 18:45:47'),
(17, 'sdx', 'patmdpt87@gmail.com', 'Qwe@1234', '2018-04-30 18:45:47'),
(1, 'dcadx', 'patmdpt@gmail.com', '', '2018-04-30 18:45:47'),
(18, 'Sonal', 'sonal@gmail.com', '!234567/', '2018-04-30 18:45:47'),
(27, 'Sonal', 'sonaldutta3@gmail.com', 'Qwe@12345', '2018-04-30 18:45:47');
