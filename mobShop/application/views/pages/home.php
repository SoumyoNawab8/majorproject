...
<section style="margin-top:2em;">
    ...
    <div class="container-fluid">
        <h4><b>Mobile less than 10,000</b></h4>
        <div class="row">
...
<section style="margin-top:2em;">
    ...
    <div class="container-fluid">
        <h4><b>Mobile more than 10,000</b></h4>
        <div class="row">
            <?php foreach($Product as $item):
                if($item['Price']>10000):
                ?>
...
<script type="text/javascript">
    ...
    var mobiles=[<?php foreach ($Product as $item) :?>"<?php echo $item['Name'];?>"<?php endforeach; ?>];
</script>